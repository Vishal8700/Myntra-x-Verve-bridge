        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            ...
            <Button
              ...
              sx={{ my: 2, color: 'black', marginLeft: '30px', display: 'block', fontSize: '16px', paddingLeft: '10px', paddingRight: '10px' }}
            >
            MEN
            </Button>
            ...
            <Button
              ...
              sx={{ my: 2, color: 'black', display: 'block', fontSize: '16px', paddingLeft: '10px', paddingRight: '10px' }}
            >
              WOMEN
            </Button><Button
          ...
          <Box sx={{ flexGrow: 0 }} className='d-fixed'>
            ...
            <div style={{ display: 'inline-block', textAlign: 'center', marginLeft: '20px' ,cursor:'pointer'}}
              ...
              <PermIdentityIcon className='m-auto'
                style={{ marginLeft: '30px', fontSize: '30px' ,cursor:'pointer'}} />
              <p >Profile</p>
            </div>

            <div style={{ display: 'inline-block', textAlign: 'center', marginLeft: '20px',cursor:'pointer' }}
              onClick={() => { props.history.push('/wishlist') }}>
              <FavoriteBorderOutlinedIcon className='m-auto' style={{ marginLeft: '30px', fontSize: '30px' ,cursor:'pointer'}} />
              <p >Wishlist</p>
            </div>
